 ...
 */
public class VitalSignsWeightFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) layout.findViewById(R.id.vitalsWeightSwipeRefreshContainer);
